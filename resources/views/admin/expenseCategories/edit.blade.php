    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.expense-categories.update", [$expenseCategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $expenseCategory->description) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tax_line') ? 'is-invalid' : '' }}" type="text" name="tax_line" id="tax_line" value="{{ old('tax_line', $expenseCategory->tax_line) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('balance_total') ? 'is-invalid' : '' }}" type="number" name="balance_total" id="balance_total" value="{{ old('balance_total', $expenseCategory->balance_total) }}" step="0.01" required>
